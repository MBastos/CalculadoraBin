...
${TESTDIR}/SomaBinariaTest.o: SomaBinariaTest.c 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/SomaBinariaTest.o SomaBinariaTest.c
...
${OBJECTDIR}/Calculadora_nomain.o: ${OBJECTDIR}/Calculadora.o Calculadora.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Calculadora_nomain.o Calculadora.c;\
	else  \
...
${OBJECTDIR}/Conversor_nomain.o: ${OBJECTDIR}/Conversor.o Conversor.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Conversor_nomain.o Conversor.c;\
	else  \
